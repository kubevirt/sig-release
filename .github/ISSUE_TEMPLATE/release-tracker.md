...
* [Release Timeline](https://github.com/kubevirt/sig-release/tree/main/releases/v.XX) <!-- DON'T FORGET TO UPDATE THE LINK -->
...
- [ ] Feature Freeze:
    ...
    - [ ] Tag v1.XX.0-rc.0 on main and branch release-1.XX from v1.XX.0-rc.0.
